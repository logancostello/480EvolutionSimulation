...
After running the simulation, the resulting data will be stored in the ```data/``` folder. Charts and figures can be generated in the ```analytics/analytics.ipynb``` file

## Report Reproduction
In order to reproduce the results in our report, use the following config settings and seeds
