...
from config import (
    NEW_WEIGHT_MEAN,
    NEW_WEIGHT_SD,
    INIT_CONNECTION_RATE,
    NUM_VALID_MUTATION_ATTEMPTS,
    ANY_WEIGHT_MUTATION_RATE,
    WEIGHT_MUTATION_RATE,
    WEIGHT_SIGN_FLIP_MUTATION_RATE,
    NEW_EDGE_MUTATION_RATE,
    NEW_NODE_MUTATION_RATE,
    REMOVE_NODE_MUTATION_RATE,
    REMOVE_EDGE_MUTATION_RATE,
    WEIGHT_MUTATION_MEAN,
    WEIGHT_MUTATION_SD
)
